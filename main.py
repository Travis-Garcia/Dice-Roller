...
while start == 0:
  ...
  dice_type = int(
    input("What sided dice would you like to roll? (example: d20 is 20) "))
  ...
  while dice_modifier != True:
    ask_modifier = input(
      "Is there a modifier you would like to add after rolling? (yes/no) ")
...
# This block should be readded after
  ...
  print(
    f"You rolled {dice_list} with a modifier of {modifier} for a total of {total+modifier}!"
  )
